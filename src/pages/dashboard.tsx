...
const prod = [
  { img: p1, name: "Продажи", color: "#FEF3F2", price: 152 },
  { img: p2, name: "Себестоимость", color: "#FEF3F2", price: 99.7 },
  { img: p3, name: "Прибыль", color: "#FEF3F2", price: 32.1 },
];
...
const Dashboard = () => {
  ...
  return (
    <div>
      <h1 className="font-bold text-2xl md:text-3xl">Панель управления</h1>
      ...
      <div className="mt-4 flex flex-col xl:flex-row gap-6">
        ...
        <div className="w-full xl:w-[35%] border rounded-md p-5 py-6">
          <div className="flex items-center justify-between">
            <span className="font-semibold">Топ продаваемые товары</span>
            <Link to={"/products"}>
      ...
      <div className="mt-10 flex flex-col xl:flex-row gap-6">
        {[
          ...
          "Топ пользователей по проданным единицам",
        ].map((title, idx) => (
          <div
            key={idx}
            className="
      ...
      "
          >
            ...
            <div
              className="max-h-[340px] overflow-y-auto rounded-xl"
